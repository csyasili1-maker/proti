...
export default function PricingPlans() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full relative overflow-hidden bg-[#f8fafc]"
    >
      {/* Soft light background accents */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute -top-40 right-[-120px] w-[420px] h-[420px] rounded-full opacity-40 blur-3xl"
          style={{
            background: 'radial-gradient(circle, rgba(189,41,40,0.16) 0%, transparent 70%)',
          }}
        />
        <div
          className="absolute -bottom-44 left-[-120px] w-[380px] h-[380px] rounded-full opacity-40 blur-3xl"
          style={{
      ...
      <div className="px-4 sm:px-6 lg:px-10 max-w-[1440px] mx-auto relative z-10 py-16 md:py-24">
        {/* Section Header */}
        <div
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand/15 bg-white mb-5 shadow-sm">
            <i className="ri-vip-crown-line text-[#d97706] text-sm" />
            <span className="text-dark/60 text-xs font-semibold tracking-wide uppercase">
              Flexible Pricing
            </span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-dark mb-5 tracking-tight">
            Choose Your{' '}
            <span
          ...
          <p className="text-dark/55 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
        ...
        {/* Pricing Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-6 max-w-6xl mx-auto items-stretch">
          {plans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                {isPopular && (
                  <div
                    className="absolute -inset-[1px] rounded-2xl opacity-50 blur-md transition-opacity duration-500"
                    style={{
                ...
                {/* Card */}
                <div
                  className={`relative h-full rounded-2xl border bg-white overflow-hidden transition-all duration-500 ${
                    plan.borderColor
                  } ${
                    isHovered || isPopular
                ...
                >
                  ...
                  <div className="p-6 md:p-7 lg:p-8 h-full flex flex-col">
                    ...
                    <div className="mb-6">
                      ...
                      <h3 className="text-dark font-bold text-lg tracking-tight">
                        {plan.name}
                      </h3>
                    ...
                    <div className="mb-8 pb-6 border-b border-gray-100">
                      <div className="flex items-baseline gap-1">
                        ...
                        <span className="text-dark text-5xl md:text-6xl font-extrabold tracking-tighter">
                          {plan.price}
                        </span>
                        <span className="text-dark/45 text-sm font-medium ml-1">
                          {plan.period}
                        </span>
                      </div>
                    ...
                    <div className="mb-8 flex-1">
                      <p className="text-dark/45 text-xs font-semibold uppercase tracking-wider mb-4">
                        What's Included
                      </p>
                      <ul className="space-y-3.5">
                        {plan.features.map((feature, idx) => (
                          ...
                          >
                            ...
                            <span className="text-dark/65 text-sm leading-relaxed group-hover:text-dark transition-colors duration-300">
                              {feature}
                            </span>
                          </li>
                        ))}
        ...
        >
          <p className="text-dark/45 text-sm">
            ...
            <Link
              to="/contact"
              className="text-brand hover:text-brand-dark font-medium underline underline-offset-4 transition-colors duration-300"
            >
