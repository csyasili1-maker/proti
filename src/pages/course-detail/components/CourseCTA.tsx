...
function getWhatsAppMessage(course: Course): string {
  const lines = [
    '👋 Hi PROITKEYS Team,',
    '',
    `I want to enroll in the *${course.title}* course.`,
    '',
    '📋 Course Details:',
    `   • Course: ${course.title}`,
    ...
    '',
    'I would like to know about upcoming batch dates, pricing, and payment options.',
    '',
    'Thank you!',
  ];
        ...
        <div className="bg-dark rounded-3xl overflow-hidden relative py-14 md:py-20 px-6 md:px-16">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-display text-white leading-tight mb-6">
              Ready to Launch Your <span className="text-brand-light">{course.category}</span> Career?
            </h2>

            <p className="text-white/65 text-base md:text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              Your first step is a conversation. Talk to an advisor about batch schedules, payment options, and how the {course.title} program fits your career goals.
            </p>
