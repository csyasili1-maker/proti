import { generateSalaryData } from '@/utils/courseDetailUtils';
...
export default function CourseSalary({ course }: CourseSalaryProps) {
  const salaryRows = generateSalaryData(course);
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 w-full">
            ...
            <p className="text-dark/60 text-base leading-relaxed mb-4">
              {course.category} professionals are in high demand across industries. Here&apos;s what you can expect based on experience level and specialization in the US market.
            </p>
          ...
          <div className="flex-1 w-full">
            <div className="bg-light rounded-2xl overflow-hidden">
              <div className="grid grid-cols-2 bg-dark text-white text-xs font-semibold uppercase tracking-wider">
                ...
                <div className="px-5 py-3">Average Salary (US)</div>
              </div>
